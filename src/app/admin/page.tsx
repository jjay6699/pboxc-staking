      ...
      <div className="admin-dashboard">
        ...
        {stats && (
          <section className="admin-stats">
            <div><span>Total value locked</span><strong>{stats.tvl.toLocaleString()} token</strong></div>
        ...
        <form onSubmit={save} className="admin-settings">
          <section className="admin-card">
            ...
            <div className="admin-grid-three">
              <label>Minimum stake (token)<input type="number" min="0.000001" step="0.000001" value={settings.minDepositSol} onChange={(event) => setNumber("minDepositSol", event.target.value)} /></label>
              <label>Maximum stake (token)<input type="number" min="0.000001" step="0.000001" value={settings.maxDepositSol} onChange={(event) => setNumber("maxDepositSol", event.target.value)} /></label>
              <label>Base CREX / staked token / day<input type="number" min="0.000001" step="0.01" value={settings.baseRate} onChange={(event) => setNumber("baseRate", event.target.value)} /></label>
            </div>
